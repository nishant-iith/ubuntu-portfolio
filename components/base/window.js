...
export class Window extends Component {
    ...
    restoreWindow = () => {
        var r = document.querySelector("#" + this.id);
        this.setDefaultWindowDimension(); // fixed typo here
...
Window.propTypes = {
    ...
    screen: PropTypes.oneOfType([PropTypes.func, PropTypes.node]),
    ...
    render() {
        return (
            <div className={"w-full flex-grow z-20 max-h-full overflow-y-auto windowMainScreen" + (this.state.setDarkBg ? " bg-ub-drk-abrgn " : " bg-ub-cool-grey")}>
                {this.props.addFolder ? displayTerminal(this.props.addFolder, this.props.openApp) : (this.props.screen && typeof this.props.screen === 'function' ? this.props.screen() : this.props.screen)}
            </div>
        )
    }
}

WindowMainScreen.propTypes = {
    screen: PropTypes.oneOfType([PropTypes.func, PropTypes.node]),
    title: PropTypes.string,
    addFolder: PropTypes.func,
    openApp: PropTypes.func,
